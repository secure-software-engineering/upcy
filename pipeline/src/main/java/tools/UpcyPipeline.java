...
public class UpcyPipeline extends ToolPipeline {
  ...
  @Override
  public void runTool(Path projectDir, String projectName, Path csvFile, Path outputDir, Map<String, List<NaiveUpdateStep>> naiveUpdatesStepsPerModule) {
    ...
    for (Map.Entry<String, List<NaiveUpdateStep>> module : naiveUpdatesStepsPerModule.entrySet()) {
      try {
        ...
        aggResults.addAll(MainComputeUpdateSuggestion.
            runOnModule(
